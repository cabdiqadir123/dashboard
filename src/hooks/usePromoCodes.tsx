...
export const usePromoCodes = () => {
  ...
  const fetchPromoCodes = async () => {
    try {
      ...
      const response = await fetch('https://api.xirfadsan.com/api/discount/allnew');
  ...
  const createPromoCode = async (
    ...
    try {
      ...
      const response = await axios.post(
        "https://api.xirfadsan.com/api/discount/addNew",
        formData,
  ...
  const updatePromoCode = async (promoId: string, updates: Partial<PromoCode>) => {
    try {
      ...
      const userResponse = await axios.put(
        `https://api.xirfadsan.com/api/discount/updateNew/${promoId}`,
        formData,
        {
          headers: { "Content-Type": "multipart/form-data" },
        }
  ...
  const deletePromoCode = async (promoId: string) => {
    try {
      ...
      await axios.post(
        "https://api.xirfadsan.com/api/discount/delete",
        { id: promoId } 
      );
