...
export const useCategories = () => {
  ...
  const fetchCategories = async () => {
    try {
      ...
      const response = await fetch('https://api.xirfadsan.com/api/services/allNew');
  ...
  const createCategory = async (
    ...
    try {
      ...
      const response = await axios.post(
        'https://api.xirfadsan.com/api/services/add',
        formData,
  ...
  const updateCategory = async (categoryId: string, updates: Partial<Category>) => {
    try {
      ...
      const response = await axios.put(
        `https://api.xirfadsan.com/api/services/update/${categoryId}`,
        formData,
        {
          headers: { "Content-Type": "multipart/form-data" },
        }
  ...
  const deleteCategory = async (categoryId: string) => {
    try {
      ...
      const response= await axios.post(
        "https://api.xirfadsan.com/api/services/delete",
