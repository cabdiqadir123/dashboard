...
export const useContactMessages = () => {
  ...
  const fetchContactMessages = async () => {
    try {
      ...
      const res = await axios.get("https://api.xirfadsan.com/api/contact/all");
  ...
  const markAsRead = async (id: string) => {
    try {
      const response = await axios.put(
        `https://api.xirfadsan.com/api/contact/update_is_read/${id}`,
        { is_read: true },
  ...
  const markAsReplied = async (id: string) => {
    try {
      ...
      const response = await axios.put(
        `https://api.xirfadsan.com/api/contact/update_replied_at/${id}`,
        {
          is_read: true,
