...
export const useSubServices = () => {
  ...
  const fetchSubServices = async () => {
    try {
      ...
      const response = await fetch('https://api.xirfadsan.com/api/subservices/allNew');
  ...
  const createSubService = async (
    ...
    try {
      ...
      const response = await axios.post(
        "https://api.xirfadsan.com/api/subservices/add_new",
        formData,
        {
  ...
  const updateSubService = async (subServiceId: string, updates: Partial<SubService>) => {
    try {
      ...
      const response = await axios.put(
        `https://api.xirfadsan.com/api/subservices/updateNew/${subServiceId}`,
        formData,
        {
          headers: { "Content-Type": "multipart/form-data" },
        }
  ...
  const deleteSubService = async (subServiceId: string) => {
    try {
      ...
      const response = await axios.post(
        "https://api.xirfadsan.com/api/subservices/delete",
